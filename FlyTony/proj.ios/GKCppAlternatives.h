...
struct GKChallengeCpp {
    ...
    std::string issuingPlayerID; // The GKPlayer who issued the challenge
    std::string receivingPlayerID; // The GKPlayer who has received the challenge
    GKScoreCpp gkScore;
//    GKChallengeState state; // Current state of the challenge
//NSDate *issueDate; // Date the challenge was issued
//NSDate *completionDate; // Date the challenge was completed or aborted
    std::string message;
};
